...
public class ItemController {
    ...
    public ResponseEntity<Object> postComment(@RequestHeader(value = "X-Sharer-User-Id") Long userId,
    ...
    @PatchMapping("/{itemId}")
    public ResponseEntity<Object> updateItemInfo(@RequestHeader("X-Sharer-User-Id") Long userId,
                                                 @PathVariable Long itemId,
                                                 @RequestBody ItemDto itemDto) {
    ...
    @GetMapping("/{itemId}")
    public ResponseEntity<Object> getItemByIdWithBookingHistory(@RequestHeader("X-Sharer-User-Id") Long userId,
    ...
    @GetMapping("/search")
    public ResponseEntity<Object> searchItemsByUserId(@RequestHeader("X-Sharer-User-Id") Long userId,
